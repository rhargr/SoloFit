...
class ClientRate extends Component {
  ...
  onCreateReview = () => {
    ...
    const review = { rating: this.state.rating, text: this.state.text, trainer_id: trainerId, trainee_id: 71 };
      ...
      <React.Fragment>
        ...
        >
          <div>
            ...
            >
              <div className="card w-50" style={{opacity: .8}}>
                <div className="card-body">
                  <h5 className="card-title" style={{ fontFamily: "Oswald", fontSize: '30px' }}>
                    Rate
                  </h5>
