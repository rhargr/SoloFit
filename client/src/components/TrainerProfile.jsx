                                ...
                                <div class="list-group">
                                    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1">What is the benefit working with a Personal Trainer?</h5>
                                            <small>3 days ago</small>
                                        </div>
                                        <p class="mb-1">Working with a Personal Trainer ensures the exercises performed are specific to your goals and are executed safely. Our team of Personal Trainers has the knowledge and skills required to work around injuries and medical conditions that make effective exercise difficult. One-on-One Personal Training offers a schedule that is flexible and based on your needs.</p>
                                    </a>
                                    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1">Is my fitness level high enough to work with a Personal Trainer?</h5>
                                            <small class="text-muted">3 days ago</small>
                                        </div>
                                        <p class="mb-1"> Of course! The Personal Trainers at Adventure 212 Fitness work with clients of all fitness levels. It is a misconception that only the super-fit work with Personal Trainers. The exercise selection is based on YOUR fitness level to provide the appropriate workout during your session with the trainer.</p>
                                    </a>
                                    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1">How many times each week should I work with a Personal Trainer?</h5>
                                            <small class="text-muted">3 days ago</small>
                                        </div>
                                        <p class="mb-1">If you are new to exercise, working with a trainer 2-3 times/week is recommended. If possible, training should not occur on consecutive days to allow the body time to rest and heal.</p>
                                    </a>
                                    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1">How many sessions should I purchase?</h5>
                                            <small class="text-muted">3 days ago</small>
                                        </div>
                                        <p class="mb-1">The number of sessions you purchase is completely up to you. Most clients choose between 12 and 24 sessions but we can accommodate any number.</p>
                                    </a>
                                    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1">I am a little apprehensive about Presonal Training; what is a "typical" session like?</h5>
                                            <small class="text-muted">3 days ago</small>
                                        </div>
                                        <p class="mb-1">Each session begins with a warm-up to prepare the body for exercise. Many of our trainers like to use a standard warm-up that is easy for the client to learn. In fact, we have many clients that arrive a little early and warm-up on their own so they have more time to exercise with the trainer.
