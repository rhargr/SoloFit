          ...
          >
            ...
            >
              ...
              <div>
                <div style={{ paddingLeft: "10px", textAlign: "left" }}>
                  ...
                  >
                    Name: <input name="name" value={this.state.user.name} onChange={this.handleUserChange} />
                  </h2>
                  <p
                    style={{
                      fontFamily: "Josefin Sans, sans-serif",
                  ...
                  >
                    Age: <input name="age" value={this.state.user.age} onChange={this.handleUserChange} />
                  </p>
                  <p
                    style={{
                      fontFamily: "Josefin Sans, sans-serif",
            ...
            <div id="address" style={{ textAlign: "start" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                <div>
                  <h3>St 1:</h3>
                  <input value={this.state.user.street1} onChange={this.handleAddressChange}/>
                </div>
                <div>
                  <h3>St 2:</h3>
                  <input value={this.state.user.street2} onChange={this.handleAddressChange}/>
                </div>
                <div>
                  <h3>City:</h3>
                  <input value={this.state.user.city} onChange={this.handleAddressChange}/>
                </div>
                <div>
                  <h3>State:</h3>
                  <select
                ...
                <div>
                  <h3>ZIP:</h3>
                  <input value={this.state.user.zip}  onChange={this.handleAddressChange}/>
                </div>
              </div>
            </div>
            ...
            <div id="AboutMe">
              <div>
                <h2>About Me</h2>
                <textarea
                  style={{ height: "100px", width: "stretch" }}
                ...
                {this.state.services.map(service => {
                  return (
                    <div className="col-md-4 col-sm-6" key={service.id}>
                      ...
                      />
                      <span>{upperFirst(service.name)}</span>
                    </div>
                  );
                })}
              </div>
